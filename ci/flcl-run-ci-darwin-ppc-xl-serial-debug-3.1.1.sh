...
setenv CI_KOKKOS_PATH /home/$USER/kt/3.1.1-ppc-xl-16.1.1.6-serial-debug/lib64/cmake/Kokkos
setenv CI_BUILD_DIR $CI_PATH_PREFIX/ci/build-3.1.1-ppc-xl-16.1.1.6-serial-debug
setenv CI_INSTALL_DIR $CI_PATH_PREFIX/ci/install-3.1.1-ppc-xl-16.1.1.6-serial-debug
rm -rf $CI_BUILD_DIR
