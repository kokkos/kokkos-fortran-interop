...
setenv CI_KOKKOS_PATH /home/$USER/kt/3.0-ppc-gcc-7.4.0-serial/lib64/cmake/Kokkos
setenv CI_BUILD_DIR $CI_PATH_PREFIX/ci/build-3.0-ppc-gcc-7.4.0-serial
setenv CI_INSTALL_DIR $CI_PATH_PREFIX/ci/install-3.0-ppc-gcc-7.4.0-serial
rm -rf $CI_BUILD_DIR
