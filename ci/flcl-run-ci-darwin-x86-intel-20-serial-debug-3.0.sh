...
setenv CI_KOKKOS_PATH /home/$USER/kt/3.0-x86-intel-20.0.1-serial-debug/lib64/cmake/Kokkos
setenv CI_BUILD_DIR $CI_PATH_PREFIX/ci/build-3.0-x86-intel-20.0.1-serial-debug
setenv CI_INSTALL_DIR $CI_PATH_PREFIX/ci/install-3.0-x86-intel-20.0.1-serial-debug
rm -rf $CI_BUILD_DIR
