...
setenv CI_COMPILER_FAMILY cce
setenv CI_COMPILER_VER 11.0.4
setenv CI_COMPILER_NAME $CI_COMPILER_FAMILY$CI_SEP$CI_COMPILER_VER$CI_SEP
setenv CI_CUDA_PREFIX hip
setenv CI_CUDA_VER
setenv CI_CUDA_NAME
...
#setenv FFLAGS "-F/projects/opt/ppc64le/ibm/xlf-16.1.1.7/xlf/16.1.1/etc/xlf.cfg.rhel.7.8.gcc.9.3.0.cuda.11.0"
