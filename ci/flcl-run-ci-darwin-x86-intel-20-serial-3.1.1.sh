...
setenv CI_KOKKOS_PATH /home/$USER/kt/3.1.1-x86-intel-20.0.1-serial/lib64/cmake/Kokkos
setenv CI_BUILD_DIR $CI_PATH_PREFIX/ci/build-3.1.1-x86-intel-20.0.1-serial
setenv CI_INSTALL_DIR $CI_PATH_PREFIX/ci/install-3.1.1-x86-intel-20.0.1-serial
rm -rf $CI_BUILD_DIR
