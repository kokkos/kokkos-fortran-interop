...
setenv CI_KOKKOS_PATH /home/$USER/kt/3.1.1-x86-gcc-7.4.0-cuda-10.1-debug/lib64/cmake/Kokkos
setenv CI_BUILD_DIR $CI_PATH_PREFIX/ci/build-3.1.1-x86-gcc-7.4.0-cuda-10.1-debug
setenv CI_INSTALL_DIR $CI_PATH_PREFIX/ci/install-3.1.1-x86-gcc-7.4.0-cuda-10.1-debug
rm -rf $CI_BUILD_DIR
